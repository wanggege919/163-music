    ...
    let controller = {
        ...
        initQiniu() {
            var uploader = Qiniu.uploader({
                ...
                domain: 'pmtehoj5j.bkt.clouddn.com',     // bucket 域名，下载资源时用到，如：'http://xxx.bkt.clouddn.com/' **必需**
                //pmtehoj5j.bkt.clouddn.com
                ...
                init: {
                    ...
                    'BeforeUpload': function (up, file) {
                        // 每个文件上传前,处理相关的事情
                        window.eventHup.emit('beforeupload')
                    },
                    ...
                    'FileUploaded': function (up, file, info) {
                        window.eventHup.emit('afterupload')
                        // 每个文件上传成功后,处理相关的事情
